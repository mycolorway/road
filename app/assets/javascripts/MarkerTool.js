...
(function() {    
    ...
    BMapLib.MarkerTool = function(map, opts){
        ...
        this._map = map;
        this._opts = {
            icon: new BMap.Icon(MarkerTool.ICON_IMG, new BMap.Size(23, 25), {anchor: new BMap.Size(9, 25), imageOffset: new BMap.Size(-46, -21)}), // MarkerTool.SYS_ICONS[8], //默认选择红色雨滴样式
    ...
    MarkerTool.prototype.open = function(){
        ...
        if (!this._followMarker) {
          this._followMarker = new BMap.Marker(this._map.getCenter(), {
              enableDragging: true,
              offset: new BMap.Size(-10, -10)//偏移-10像素,解决cursor问题
          }); 
    ...
    MarkerTool.prototype._bind = function(){
        ...
        me._clickHandler = function(evt){
            ...
            mkr.addEventListener('click', rd.editPoi);
